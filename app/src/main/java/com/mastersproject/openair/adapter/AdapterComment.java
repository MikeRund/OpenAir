package com.mastersproject.openair.adapter;
...
import com.mastersproject.openair.model.Comment;

import java.util.Calendar;
import java.util.List;
import java.util.Locale;

public class AdapterComment extends RecyclerView.Adapter<com.mastersproject.openair.adapter.AdapterComment.MyHolder> {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            imagea = itemView.findViewById(R.id.commentpic);
